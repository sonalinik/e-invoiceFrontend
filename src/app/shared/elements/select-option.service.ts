...
export class SelectOptionService {
  public static readonly PLAYER_ONE: Array<IOption> = [
    {value: 'Alabama', label: 'Door Group 1'},
    {value: 'Wyoming', label: 'Door Group 2'},
    {value: 'Coming', label: 'Door Group 3'},
    {value: 'HenryDie', label: 'Door Group 4'},
    {value: 'JohnDoe', label: 'Door Group 5'}
  ];
